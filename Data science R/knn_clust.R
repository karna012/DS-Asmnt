...
#final model
fi_zoo <- knn(trn_z,tst_z,k=1,cl=trn_z$type)
mean(fi_zoo==tst_z$type)  #acc = 1
confusionMatrix(fi_zoo,tst_z$type)


#visualisation
acc_kn <- data.frame(list(train_acc=trn_acc,tst_acc=tst_acc,k=seq(1,50,2)))
acc_kn
